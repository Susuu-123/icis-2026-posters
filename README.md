...
- **Learning abstract relational terms in infancy based on cross-situational contrastive labeling**
  Elena Luchkina & Elizabeth Spelke (UT Dallas; Harvard University)
  → [`ICIS2026_same-different.pdf`](ICIS2026_same-different.pdf)

- **How do 15-to-18-month-olds represent unseen objects when such objects are being named?**
  Elena Luchkina, Emily Yang, & Sandra Waxman (UT Dallas; Northwestern University)
  → [`ICIS2026_representing-the-unseen.pdf`](ICIS2026_representing-the-unseen.pdf)

For questions or comments, please contact the Early Cognition and Communication Lab, UT Dallas.
